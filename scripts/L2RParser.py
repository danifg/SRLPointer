...
def main():
    ...
    args_parser.add_argument('--word_embedding', choices=['glove', 'glove300', 'senna', 'sskip', 'polyglot'], help='Embedding for words', required=True)
    ...
    print('SRLPointer: Semantic Role Labeling with Pointer Networks')	
